...
defmodule RasaSdk.RequestBuilder do
  @moduledoc """
  ...
  def add_param(request, :body, key, value) do
    ...
    |> Map.update!(:body, &(Tesla.Multipart.add_field(&1, key, Jason.encode!(value), headers: [{:"Content-Type", "application/json"}])))
  end
  ...
  def decode(%Tesla.Env{body: body}, struct), do: Jason.decode(body, as: struct)
